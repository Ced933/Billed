            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <input type="email" data-testid="employee-email-input" value="employee@company.tld" class="form-control" placeholder="johndoe@email.com" required autofocus>
                  <label for="inputPassword">Mot de passe</label>
                  <input type="password" data-testid="employee-password-input" value="employee" class="form-control" placeholder="******" required>
            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-admin">
                  ...
                  <label for="inputEmail">Votre email</label>
                  <input type="email" data-testid="admin-email-input" value="admin@company.tld" class="form-control" placeholder="johndoe@email.com" required autofocus>
                  <label for="inputPassword">Mot de passe</label>
                  <input type="password" data-testid="admin-password-input" value="admin" class="form-control" placeholder="******" required>
